...
function SocialRail() {
  return (
    <>
      ...
      <aside className="social-rail-brand hidden sm:flex" aria-label="Sosyal medya">
      ...
      {/* Mobile: sticky bottom WhatsApp CTA */}
      <a
        href="https://wa.me/905392437606"
        target="_blank"
        rel="noreferrer"
        aria-label="WhatsApp ile ulaşın"
        className="sm:hidden fixed bottom-0 left-0 right-0 z-50 flex items-center justify-center gap-2.5 bg-[#25D366] text-white text-[14px] font-semibold py-3.5 shadow-[0_-2px_12px_rgba(0,0,0,.12)]"
      >
        <I.Whatsapp width="22" height="22" />
        WhatsApp ile ücretsiz bilgi al
      </a>
    </>
  );
}
